...
public class TimeEntry {
    ...
    public boolean equals(Object o) {
        ...
        return getId() == timeEntry.getId() &&
                ...
                getDate().getYear() == timeEntry.getDate().getYear() &&
                getDate().getMonth() == timeEntry.getDate().getMonth() &&
                getDate().getDayOfMonth() == timeEntry.getDate().getDayOfMonth() &&
                getDate().getEra() == timeEntry.getDate().getEra();
    }
